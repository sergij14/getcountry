...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
var getdata = function getdata(country) {
  getJson("https://restcountries.eu/rest/v2/name/".concat(country), "country not found").then(function (data) {
    renderCountry(data[0]);
    var neighbours = data[0].borders;

    if (!data[0].borders[0]) {
      throw new Error("No neighbours found for ".concat(country));
    }

    neighbours.map(function (n) {
      return fetch("https://restcountries.eu/rest/v2/alpha/".concat(n)).then(function (response) {
        return response.json();
      }).then(function (data) {
        document.querySelector(".neighs").insertAdjacentText("beforeend", "".concat(data.name, " | "));
      });
    });
    countriesContainer.insertAdjacentHTML("afterend", "<p class=\"neighs\">All Neighbours:<br></p>");
    return getJson("https://restcountries.eu/rest/v2/alpha/".concat(data[0].borders[0]));
  }).then(function (data) {
    ...
    countriesContainer.insertAdjacentHTML("beforebegin", "<p class=\"rel\"><button class=\"rel__btn\" onClick=\"window.location.reload();\">Reload</button></p>");
  });
};
